...
namespace WIN.TECHNICAL.HTTP_HANDLERS
{
    public static class ObjectConverter
    {
        ...
        private static bool ConvertDictionaryToObject(IDictionary<string, object> dictionary, Type type, JavaScriptSerializer serializer, bool throwOnError, out object convertedObject)
        {
            ...
            if (IsGenericDictionary(type))
            {
                ...
                if ((type3 != typeof(string)) && (type3 != typeof(object)))
                {
                    if (throwOnError)
                    {
                        throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "DictionaryTypeNotSupported", new object[] { type.FullName }));
                    }
                    convertedObject = null;
                    return false;
                }
        ...
        public static object ConvertObjectToType(object o, Type type, JavaScriptSerializer serializer)
        {
            object obj2;
        ...
        public static bool IsClientInstantiatableType(Type t, JavaScriptSerializer serializer)
        {
        ...
        public static bool TryConvertObjectToType(object o, Type type, JavaScriptSerializer serializer, out object convertedObject)
        {
